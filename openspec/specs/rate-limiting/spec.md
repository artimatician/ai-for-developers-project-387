...
Two-layer request throttling (DRF + nginx) to protect the API from excessive requests, with
proxy-aware IP detection, configurable rates, test bypass, and consistent error format.
