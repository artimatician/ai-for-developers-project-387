# guest-booking-flow Specification

## Purpose

Guest-facing booking experience from landing page through event type selection, scheduling, booking form, and confirmation.
## Requirements
...
#### Scenario: Continue navigates to confirm page with duration
